import { Currency, VLX, JSBI, TokenAmount } from '@wagyu-swap-libs/sdk'
import React, { useCallback, useEffect, useState } from 'react'
import { Button, ChevronDownIcon, AddIcon, CardBody, Text } from '@wagyu-swap-libs/uikit'
...
export default function PoolFinder() {
  ...
  const [currency0, setCurrency0] = useState<Currency | null>(VLX)
